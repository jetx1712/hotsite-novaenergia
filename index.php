...
<body>
            ...
            <div class="col-md-12 linha">
                ...
                <div class="col-md-5 boneco">
                    <div>
                        ...
                        <a class="saiba-mais" href="#"><i style="width: 30px;" class="fa-solid fa-arrow-right"></i> Ver
                            agora</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 blocos">
                ...
                <div class="col-md-4 blocos">
                    <div class="bloco">
                        ...
                        <button><i style="width: 30px;" class="fa-solid fa-arrow-right"></i>Acesso ao formulário</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div style="background-color: #eaeaea;" class="row">
            <div class="rodape">
                <div>
        ...
        <img style="max-width: 50%" src="assets/images/imagem-footer.png" />
        <div>
