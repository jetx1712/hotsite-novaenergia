        ...
        <div class="container">
            ...
            <div class="botoes-linha-tempo">
                <div for="mostra-linha-toggle1" class="col-md-10 botao-linha-tempo">
                    <label>Desenvolvimento do planejamento e Plano de Comunicação – <span style="font-weight: 600">dezembro de 2023 a março de 2024</span></label><i id="icone-toggle1" class="bi bi-arrow-down-circle"></i>
                </div>
                <div class="mostra-linha col-md-10" id="mostra-linha-toggle1">
                    ...
                    <div class="conteudo-interno-linha-tempo">
                        <div class="col-md-4 texto-interno-linha-tempo">
                            ...
                            <p class="paragrafo-enfatico">em andamento</p>
                        </div>
                        <div class="col-md-4 texto-interno-linha-tempo">
                            <label>Processamento das <br>contas de energia</label>
                        ...
                        <div class="col-md-4 texto-interno-linha-tempo">
                            <label>Desenvolvimento da modelagem da transição e eficiência energética</label>
                            <div style="display: none;">
                                <p class="p-pequeno">Março de 2024</p>
                                <p class="paragrafo-enfatico">em andamento</p>
                            </div>
            ...
            <div class="botoes-linha-tempo">
                <div for="mostra-linha-toggle2" class="col-md-10 botao-linha-tempo">
                    <label>Análise para Otimização da Gestão – <span style="font-weight: 600">dezembro de 2023 a março de 2024</span></label><i id="icone-toggle2" class="bi bi-arrow-down-circle"></i>
                </div>
            ...
            <div class="botoes-linha-tempo">
                <div for="mostra-linha-toggle3" class="col-md-10 botao-linha-tempo">
                    <label>Modelagem da Transição Energética – <span style="font-weight: 600">dezembro de 2023 a março de 2024</span></label><i id="icone-toggle3" class="bi bi-arrow-down-circle"></i>
                </div>
